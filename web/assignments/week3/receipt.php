...
//Gets the total cost of everything in the cart
$total = 0.0;
...
<g>
        ...
        <main>
            ...
            for ($i = 1; $i <= count($catalog); $i++) {
                if (isset($_SESSION['cart'][$i])) {
                    echo "<p>" . $catalog[$i]["Name"] . " x " . $_SESSION['cart'][$i] . "</p>";
                }
            }
        
            ?>
            <h3>Your total cost was: $<?php echo $total ?></h3>
            <h3>Your item(s) will be shipped to:</h3>
            <p class="address"><?php echo htmlspecialchars($name) ?></p>
            <p class="address"><?php echo htmlspecialchars($address1) ?></p>
            <?php
            if (isset($address2)){
                echo "<p class='address'>" . htmlspecialchars($address2) . "</p>";
            }
            ?>
            <p class="address"><?php echo htmlspecialchars($city) ?></p>
            <p class="address"><?php echo htmlspecialchars($state) ?></p>
            <p class="address"><?php echo htmlspecialchars($zipcode) ?></p>
